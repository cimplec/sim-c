...
def expression(tokens, i, table, msg, accept_unkown=False, accept_empty_expression=False):
    ...
    while(i < len(tokens) and tokens[i].type in ['number', 'input','string', 'id', 'plus', 'minus', 'multiply', 'divide', 'comma', 'equal', 'not_equal', 'greater_than', 'less_than', 'greater_than_equal', 'less_than_equal','left_paren']):

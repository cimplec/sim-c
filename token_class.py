class Token():
    ...
    def token2dig(self, str_type):
        ...
        dic = {"number": 1, "string": 2, "print": 3, "identifier": 4, "left_paren": 5, "right_paren": 6,
               ...
               "fun": 14, "return": 15, "equal": 16, "not_equal": 17, "greater_than": 18, "less_than": 19, "greater_than_equal": 20, "less_than_equal": 21, "while": 22, "if": 23, "modulus": 24, "increment": 25, "decrement": 26, "plus_equal": 27, "minus_equal": 28, "multiply_equal": 29, "divide_equal": 30, "modulus_equal": 31, "and": 32, "or": 33, "do": 34}
